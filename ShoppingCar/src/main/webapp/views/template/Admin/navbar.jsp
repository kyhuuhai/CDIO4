...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
   ...
   <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <ul class="nav navbar-right top-nav">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i><strong>${pageContext.request.userPrincipal.name}</strong><b class="caret"></b></a>
                    <ul class="dropdown-menu">
                        ...
                        <li class="divider"></li>
                        <li>
                            <a onclick="document.forms['logoutForm'].submit()"><i class="fa fa-fw fa-power-off">Logout</i></a>
                        </li>
                    </ul>
                </li>
            </ul>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="customer"><i class="fa fa-fw fa-table"></i> KHÁCH HÀNG</a>
                    </li>
                    <li class="active">
